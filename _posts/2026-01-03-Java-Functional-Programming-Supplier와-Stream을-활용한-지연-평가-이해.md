...
tags: 자바
keywords: Java 지연 평가, Lazy Evaluation, Java Stream API, 자바 함수형 프로그래밍, 성능 최적화, Java Supplier, 중간 연산 최종 연산, 단락 회로(Short-Circuiting), 루프 퓨전(Loop Fusion), 순수 함수(Pure Function), 람다 표현식, 부수 효과(Side Effect)
categories: 자바
