...
tags:
keywords: SQL LIKE 성능, 데이터베이스 최적화, Full Table Scan, LIKE 와일드카드, Full-Text Search, Elasticsearch, B-Tree 인덱스, 역색인, ngram, MySQL 성능, 검색 쿼리 최적화
categories: 데이터베이스
...
<p align="center">
  <img src="/assets/img/understanding-and-using-like-in-sql.png" alt="데이터베이스 LIKE문 제대로 이해하고 사용하기" width="100%">
</p>
